...
# Register entry points for the HyperSqlDialect module...
from sqlalchemy.dialects import registry
registry.register("hsqldb", "sqlalchemy_hsqldb.base", "HyperSqlDialect")
registry.register("hsqldb.jaydebeapi", "sqlalchemy_hsqldb.jaydebeapi",
